...
if (isset($_POST['submit'])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (!empty($pesan_kesalahan)) {
            ...
            $result = mysqli_query($connection, "INSERT INTO ketidakhadiran(id_pegawai, keterangan, deskripsi, tanggal, status_pengajuan, file)
            VALUES('$id', '$keterangan', '$deskripsi', '$tanggal', '$status_pengajuan', '$nama_file') ");

            $_SESSION['berhasil'] = "Data Berhasil Di Ajukan.";
